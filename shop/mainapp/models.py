...
class Customer(models.Model):
    user = models.ForeignKey(User, verbose_name='Пользователь', on_delete=models.CASCADE) #  Какая-то дичь тут должна быть связь один к одному если мы не собираемся чтобы покупатель скажем был еще и продацов
